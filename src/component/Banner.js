        ...
        <div className="container text-light text-center text-lg-start">
          <div className="row align-items-center">
            <div className="col-lg-6 hero-text">
              ...
              <Link href="#products" className="btn btn-gradient hero-btn">Explore Our Products</Link>
            </div>
            <div className="col-lg-6 text-center">
              <img src= {("./..//images/hero img2.png")} alt="Tech Illustration" className="img-fluid hero-img" data-aos="flip-left" data-aos-duration="3000"/>
            </div>
          </div>
        </div>
      </header>
